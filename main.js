...
renderBoard(fillNewBoard()); // ynew blocl logic
...
function drawField() {
  ...
  const element = arrField.find(item => item.dataset.col === `${colRandom}` && item.dataset.row === `${rowRandow}`);
